...
# Versión: FINAL v4.3 - Despliegue en Azure Corregido
# ==============================================================================
...
# --- INICIO: CORRECCIÓN FINAL DE COOKIES PARA PRODUCCIÓN ---
# En producción (cuando DEBUG=False), necesitamos ajustar la política de SameSite
# para permitir que el frontend envíe el cookie CSRF correctamente.
if not DEBUG:
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256", "SIGNING_KEY": SECRET_KEY, "VERIFYING_KEY": None, "AUDIENCE": None,
